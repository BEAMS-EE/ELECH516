...
\Question{
	...
	We want to maintain the level in the reservoir in such a way that the tank is refiled up to \texttt{I0.0} as soon as the level get below \texttt{I0.1} (Figure~\ref{fig:reservoir-empty}).
