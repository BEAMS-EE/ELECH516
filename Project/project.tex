...
\newcommand{\fileTitle}{Project 2017 - 2018}
...
The purpose of the project is to model behavior of the elevator that serves three different floors.
The system is equipped with	
\begin{itemize}
	\item{6 sensors}
	\begin{itemize}
		\item{3 level captors (AtLevel1, AtLevel2, AtLevel3).}
